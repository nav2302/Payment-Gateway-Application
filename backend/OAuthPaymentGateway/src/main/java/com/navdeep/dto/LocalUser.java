...
public class LocalUser extends User implements OAuth2User, OidcUser {
	...
	private com.navdeep.model.User user;
	...
	public LocalUser(final String userID, final String password, final boolean enabled, final boolean accountNonExpired, 
			...
			final com.navdeep.model.User user) {
	...
	public LocalUser(final String userID, final String password, final boolean enabled, final boolean accountNonExpired, 
			final boolean credentialsNonExpired, final boolean accountNonLocked, final Collection<? extends GrantedAuthority> authorities, 
			final com.navdeep.model.User user, OidcIdToken idToken, OidcUserInfo userInfo) {
	...
	public static LocalUser create(com.navdeep.model.User user, Map<String, Object> attributes, OidcIdToken idToken, OidcUserInfo userInfo) {
	...
	public com.navdeep.model.User getUser() {
		return user;
	}
}
